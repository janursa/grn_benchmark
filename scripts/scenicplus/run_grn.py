...
tf_file = f'{work_dir}/utoronto_human_tfs_v_1.01.txt'

if False:
    adata = sc.read_h5ad('../output/scRNA/adata_rna.h5ad')
    ...
    with open(os.path.join(work_dir, 'grn/scplus_obj.pkl'), 'wb') as f:
