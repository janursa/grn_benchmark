...
Requires op_rna.h5ad and op_atac.h5ad in $EVALUATION_DIR.
Output: $RESULTS_DIR/experiment/skeleton/skeleton.csv
...
par = {
    "rna":            f"{env['EVALUATION_DIR']}/op_rna.h5ad",
    "atac":           f"{env['EVALUATION_DIR']}/op_atac.h5ad",
    ...
    "temp_dir":        f"{env['RESULTS_DIR']}/experiment/skeleton/tmp",
    "out_skeleton":    f"{env['RESULTS_DIR']}/experiment/skeleton/skeleton.csv",
    "flank_length":    1000,
