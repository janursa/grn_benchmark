...
export CONTROL_METHODS_DIR="${TASK_GRN_INFERENCE_DIR}/src/control_methods"
...
# echo "CONTROL_METHODS_DIR=$CONTROL_METHODS_DIR"
...
for var in TASK_GRN_INFERENCE_DIR GRN_BENCHMARK_DIR PYTHONPATH RESULTS_DIR IMAGES_DIR RESOURCES_DIR INFERENCE_DIR EVALUATION_DIR PRIOR_DIR EXTENDED_DIR METHODS_DIR CONTROL_METHODS_DIR METRICS_DIR UTILS_DIR; do
    value="$(eval echo "\"\$$var\"")"
